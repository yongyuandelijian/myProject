...
class get_ybwb(object):
    ...
    def hqnr(self):
        ...
        nr01 = "截至2021年1月31日，镜像层的生产项目共有112个，包括36个国税项目（由于国地税已合并，目前不使用地税项目，仅使用国税项目）、1个快速加工项目、34个地税项目、36个准实时项目，以及实名办税、汇算清缴、国税总局等5个其他项目。在镜像层的项目中38个项目是正常运维使用，34个地税项目已停用，36个准实时项目由集成组每天巡检，全部任务正常运行完成，其余4个项目无专人维护。本次报告对38个项目空间任务进行分析。"
        nr02 = '（注：镜像层生产项目统计口径：项目空间名称以"SC_JX_"开头，且不包含“SC_JX_ZRRYH%”,"SC_JX_DQYS"）'
        nr03 = "生产项目空间的任务数量统计如下表："
        jb2_31 = {jb2_31: [nr01, nr02, nr03]}
        ...
        nr01 = "截至2021年1月31日，基础层共有10个生产项目空间，其中有8个私有空间。私有空间为各省提供自主开发使用，不做日常运维，因此不做展开分析。基础层的生产项目空间如下表所示。"
        jb2_41 = {jb2_41: [nr01]}
